% FOR REFERENCE ONLY (see tickle, tickle2)
%
...
function varargout = tickle1(opt, pos, f, tfType)
  ...
  if ~isNoise
    ...
    [sigAC, mMech] = tickleAC(opt, f, vLen, vPhiGouy, ...
    ...
    [sigAC, mMech, noiseAC, noiseMech] = tickleAC1(opt, f, vLen, ...
